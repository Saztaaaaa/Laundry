        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                    	<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i glyphicon glyphicon-wrench></i>Pengaturan<span class="caret"></span></a>
                ...
                <li><a href="logout.php"><i class="glyphicon glyphicon-log-out"0></i>Log Out</a></li>
            </ul>
